...
openssl req -new -x509 -sha256 -days 730 -key $keys_path/ca.key -out $keys_path/ca.crt -passin pass:$password -subj "/CN=webconsole"
...
echo
echo "You can complete setup by running './setup.sh $keys_path/server.key $keys_path/server.crt'"
